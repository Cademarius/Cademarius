...
export function ArticleCard({
  ...
  if (layout === "horizontal") {
    return (
      <div className="group overflow-hidden rounded-lg border transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1 bg-card flex">
        <Link href={`/blog/${slug}`} className="block w-1/3 min-w-[120px]">
